...
const CARD_KEYS = ["family", "fraud", "estate", "enforcement"] as const;

export default async function CryptoAssetIdentificationAudiences() {
  const t = await getTranslations("CryptoAssetIdentification.Audiences");
