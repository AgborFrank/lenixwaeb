...
export default async function CryptoAssetIdentificationHero() {
  const t = await getTranslations("CryptoAssetIdentification.Hero");
      ...
      <div className={home.container}>
        <div className="max-w-3xl space-y-5">
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            <a href="#case-review" className={home.btnPrimary}>
              {t("btn_primary")}
            </a>
