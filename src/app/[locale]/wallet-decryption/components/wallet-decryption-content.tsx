...
export function WalletDecryptionContent() {
  const t = useTranslations("WalletDecryption");
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex">
          <div className="md:w-[70%] w-full">
            ...
            <div className="flex flex-wrap gap-4 mt-10">
              <Link href="/contact"
                  className="bg-yellow-400 flex hover:bg-yellow-500 text-black font-bold py-3 px-8 rounded-full shadow-lg shadow-yellow-400/20"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <ServiceCard
              ...
              title={t("Approach.card1_title")}
              description={t("Approach.card1_desc")}
            />
            <ServiceCard
              icon={<Key className="w-6 h-6 text-blue-400" />}
              title={t("Approach.card2_title")}
              description={t("Approach.card2_desc")}
            />
            <ServiceCard
              icon={<Database className="w-6 h-6 text-emerald-400" />}
              title={t("Approach.card3_title")}
              description={t("Approach.card3_desc")}
            />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <Image src="/assets/img/staff.jpg" alt="Wallet Decryption" fill className="object-cover rounded-2xl" />
              </div>
            </div>
          </div>
        </div>
...
// Ensure the Search icon is imported from lucide-react, I will manually add it right now.
// For the sake of the component, I'll define it here if not imported:
