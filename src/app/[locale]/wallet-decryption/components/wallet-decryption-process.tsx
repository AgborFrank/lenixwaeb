...
const STEPS = [
  ...
  { id: "scope", image: "/assets/img/investigate.webp" },
  { id: "recover", image: "/assets/img/trade-routes.jpg" },
] as const;

export default async function WalletDecryptionProcess() {
  const t = await getTranslations("WalletDecryption.Process");

  return (
    <section id="assessment" className={`${home.section} bg-black scroll-mt-24`}>
