...
const PILLARS = [
  { id: "coverage", imageSrc: "/assets/img/MonitorRisk.webp", imagePosition: "right" as const },
  { id: "integration", imageSrc: "/assets/img/BringDeFiIntelligence.webp", imagePosition: "left" as const },
  { id: "screening", imageSrc: "/assets/img/UncoverIllicitConnections.webp", imagePosition: "right" as const },
  { id: "monitoring", imageSrc: "/assets/img/DetectFinancialCrime.webp", imagePosition: "left" as const },
  { id: "onboarding", imageSrc: "/assets/img/investigate.webp", imagePosition: "right" as const },
  { id: "diligence", imageSrc: "/assets/img/security.webp", imagePosition: "left" as const },
] as const;

export default async function DeFiComplianceCapabilities() {
  const t = await getTranslations("DeFiCompliance.Capabilities");
