...
export default async function DeFiComplianceCta() {
  const t = await getTranslations("DeFiCompliance.Cta");
    ...
    <section className="py-24 bg-black relative">
      <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3">
          ...
          <Link href="/compliance-investigations" className={`${home.btnSecondary} h-12 px-10 text-base`}>
            {t("btn_secondary")}
          </Link>
        </div>
      </div>
