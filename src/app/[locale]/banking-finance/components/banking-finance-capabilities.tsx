...
const PILLARS = [
  { id: "transfer", imageSrc: "/assets/img/trade-routes.jpg", imagePosition: "right" as const },
  { id: "settlement", imageSrc: "/assets/img/bank-account.svg", imagePosition: "left" as const },
  { id: "liquidation", imageSrc: "/assets/img/enhance.webp", imagePosition: "right" as const },
  { id: "lending", imageSrc: "/assets/img/BringDeFiIntelligence.webp", imagePosition: "left" as const },
  { id: "custody", imageSrc: "/assets/img/investigate.webp", imagePosition: "right" as const },
  { id: "compliance", imageSrc: "/assets/img/MonitorRisk.webp", imagePosition: "left" as const },
] as const;

export default async function BankingFinanceCapabilities() {
  const t = await getTranslations("BankingFinance.Capabilities");
      ...
      {PILLARS.map(({ id, imageSrc, imagePosition }, index) => (
        ...
        >
          <div className="absolute inset-0 z-0">
            <Image src="/assets/img/bg.jpg" alt="" fill className="object-cover opacity-[0.15]" />
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
              <div className={imagePosition === "right" ? "md:order-1" : "md:order-2"}>
                ...
                <h3 className="text-4xl md:text-5xl lg:text-[3.25rem] font-semibold text-white mb-6 leading-tight">
                  {t(`pillars.${id}.title`)}
                </h3>
              ...
              <div className={imagePosition === "right" ? "md:order-2" : "md:order-1"}>
                <div className="relative w-full h-[400px] lg:h-[500px] rounded-3xl overflow-hidden bg-black/20 border border-white/10">
                  <Image
                    ...
                    fill
                    className={imageSrc.endsWith(".svg") ? "object-contain p-8" : "object-cover"}
