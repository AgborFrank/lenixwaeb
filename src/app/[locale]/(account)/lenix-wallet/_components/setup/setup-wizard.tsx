  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-zinc-900/50 border border-white/5 rounded-2xl p-6 sm:p-10 backdrop-blur-xl">
        {step === "welcome" && (
          <WelcomeScreen onCreate={() => setStep("create")} onImport={() => setStep("import")} />
        )}

        {step === "create" && <CreateWalletFlow onComplete={onComplete} />}

        {step === "import" && <ImportWalletFlow onComplete={onComplete} />}
      </div>
    </div>
  );
}
