    ...
    <section className={`${home.section} ${home.sectionMuted}`}>
      <div className={home.container}>
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          <div>
             <div className="relative aspect-[4/3] w-auto h-[300px]">
              <Image
                src="/assets/vectors/btc_pay.svg"
                alt={t("image_alt")}
                fill
          ...
          <ul className="grid sm:grid-cols-2 gap-4 list-none p-0 m-0">
            {SIGNALS.map((id) => (
              ...
              >
                <h3 className="md:text-2xl text-lg font-semibold text-white mb-1">{t(`items.${id}.title`)}</h3>
