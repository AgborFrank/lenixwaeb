...
export default function FinanceHero() {
  const t = useTranslations("FinancePage.Hero");
      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="text-center mb-16 space-y-6 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/crypto-loan" className={`${home.btnPrimary} text-lg px-8 py-4 gap-2`}>
              {t("btn_primary")}
              <ArrowUpRight className="w-5 h-5" />
            </Link>
            <a href="#markets" className={`${home.btnSecondary} text-lg px-8 py-4`}>
              {t("btn_secondary")}
            </a>
          </div>
        </div>
            ...
            <div className="h-16 border-b border-white/5 bg-white/5 backdrop-blur-md flex items-center justify-between px-8 relative z-10">
              <div className="flex items-center gap-8">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-white">{t("mock.brand")}</span>
                </div>
                <div className="hidden md:flex gap-6 text-sm font-medium text-gray-400">
                  <span className="text-white">{t("mock.nav_dashboard")}</span>
                  <span className="hover:text-white cursor-pointer">{t("mock.nav_markets")}</span>
                  <span className="hover:text-white cursor-pointer">{t("mock.nav_staking")}</span>
                  <span className="hover:text-white cursor-pointer">{t("mock.nav_governance")}</span>
                </div>
              </div>
              ...
              <div className="lg:col-span-2 space-y-6">
                <div className="grid sm:grid-cols-3 gap-4">
                  <div className="bg-white/5 rounded-xl p-5 border border-white/5">
                    <p className="text-gray-400 text-xs font-mono mb-1">{t("mock.net_worth")}</p>
                  ...
                  <div className="bg-white/5 rounded-xl p-5 border border-white/5">
                    <p className="text-gray-400 text-xs font-mono mb-1">{t("mock.net_apy")}</p>
                  ...
                  <div className="bg-white/5 rounded-xl p-5 border border-white/5">
                    <p className="text-gray-400 text-xs font-mono mb-1">{t("mock.health_factor")}</p>
                    <h3 className="text-2xl font-bold text-green-400">1.85</h3>
                    <p className="text-xs text-gray-500 mt-1">{t("mock.liquidation_note")}</p>
                  </div>
                </div>

                <div className="bg-white/5 rounded-xl border border-white/5 overflow-hidden">
                  <div className="flex border-b border-white/5">
                    <button type="button" className="px-6 py-4 text-white font-medium border-b-2 border-yellow-400 bg-white/5">
                      {t("mock.tab_supplied")}
                    </button>
                    <button type="button" className="px-6 py-4 text-gray-500 font-medium hover:text-white">
                      {t("mock.tab_borrowed")}
                    </button>
                  </div>
                  <div className="p-4">
                    <table className="w-full text-left">
                      <thead>
                        <tr className="text-xs text-gray-500 font-mono border-b border-white/5">
                          <th className="pb-3 pl-2">{t("mock.col_asset")}</th>
                          <th className="pb-3">{t("mock.col_balance")}</th>
                          <th className="pb-3">{t("mock.col_apy")}</th>
                          <th className="pb-3">{t("mock.col_collateral")}</th>
                        </tr>
                      </thead>
                      <tbody className="text-sm">
                        <tr className="border-b border-white/5 last:border-0 group hover:bg-white/5 transition-colors">
                          <td className="py-4 pl-2 flex items-center gap-3">
                            <TokenIcon symbol="WBTC" size={32} />
                            <span className="text-white font-medium">WBTC</span>
                          </td>
                          <td className="py-4 text-white">
                            1.2500{" "}
                            <span className="text-gray-500 text-xs block">$54,200.00</span>
                          </td>
                          <td className="py-4 text-green-400">4.2%</td>
                          <td className="py-4 text-green-400">{t("mock.enabled")}</td>
                        </tr>
                        <tr className="group hover:bg-white/5 transition-colors">
                          ...
                          <td className="py-4 text-white">
                            15.000{" "}
                            <span className="text-gray-500 text-xs block">$34,500.00</span>
                          </td>
              ...
              <div className="bg-white/5 rounded-xl border border-white/5 p-6 flex flex-col h-full">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex justify-between text-xs text-gray-500 px-1">
                    <span>{t("mock.wallet_balance")}</span>
                    <span>25,400.00 USDC</span>
                  </div>
                  <div className="bg-black/40 rounded-lg p-3 border border-white/5">
                    <div className="flex justify-between text-sm mb-1">
                      <span className="text-gray-400">{t("mock.supply_apy")}</span>
                      <span className="text-green-400">12.4%</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-400">{t("mock.collateral_factor")}</span>
                      <span className="text-white">82.5%</span>
                    </div>
                  </div>
                </div>

                <button type="button" className="w-full bg-yellow-400 hover:bg-yellow-300 text-black font-bold py-3 rounded-lg transition-colors mt-auto shadow-[0_0_20px_rgba(250,204,21,0.3)]">
                  {t("mock.supply_btn")}
                </button>
              </div>
            </div>
