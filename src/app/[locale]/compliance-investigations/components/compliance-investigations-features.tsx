...
const PILLARS = [
  { id: "tracing", imageSrc: "/assets/img/investigate.webp", imagePosition: "right" as const },
  { id: "workflow", imageSrc: "/assets/img/security.webp", imagePosition: "left" as const },
  { id: "diligence", imageSrc: "/assets/img/enhance.webp", imagePosition: "right" as const },
  { id: "monitoring", imageSrc: "/assets/img/scale.webp", imagePosition: "left" as const },
] as const;

export default async function ComplianceInvestigationsFeatures() {
  const t = await getTranslations("ComplianceInvestigations.Features");
