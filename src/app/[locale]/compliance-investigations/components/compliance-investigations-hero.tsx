...
export default async function ComplianceInvestigationsHero() {
  const t = await getTranslations("ComplianceInvestigations.Hero");

  return (
    <section className="relative pt-32 pb-20 overflow-hidden">
      <div className="absolute inset-0 z-0">
        <Image
          src="/assets/img/bg-2.avif"
          alt=""
          fill
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="md:w-1/2 w-full">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a href="#features" className={`${home.btnSecondary} h-12 px-8`}>
              {t("btn_secondary")}
            </a>
          </div>
        </div>
