...
interface RecoveryStatusSelectProps {
  requestId: string;
...
const statuses = [
  ...
  { value: "in_progress", label: "In Progress", className: "bg-blue-400/10 text-blue-400 border-blue-400/30" },
...
export function RecoveryStatusSelect({
  requestId,
  currentStatus,
}: RecoveryStatusSelectProps) {
