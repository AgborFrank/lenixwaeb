...
interface BankingApplicationStatusSelectProps {
  userId: string;
...
const statuses = [
  ...
  { value: "under_review", label: "Under Review", className: "bg-blue-400/10 text-blue-400 border-blue-400/30" },
...
export function BankingApplicationStatusSelect({
  userId,
  currentStatus,
}: BankingApplicationStatusSelectProps) {
