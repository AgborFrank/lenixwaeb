...
const PILLARS = [
  { id: "intelligence", imageSrc: "/assets/img/investigate.webp", imagePosition: "right" as const },
  { id: "tracing", imageSrc: "/assets/img/MonitorRisk.webp", imagePosition: "left" as const },
  { id: "triage", imageSrc: "/assets/img/UncoverIllicitConnections.webp", imagePosition: "right" as const },
  { id: "investigation", imageSrc: "/assets/img/security.webp", imagePosition: "left" as const },
  { id: "training", imageSrc: "/assets/img/BringDeFiIntelligence.webp", imagePosition: "right" as const },
] as const;

export default async function LawEnforcementCapabilities() {
  const t = await getTranslations("LawEnforcement.Capabilities");
