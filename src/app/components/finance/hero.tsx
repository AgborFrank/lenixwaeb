      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="text-center mb-16 space-y-6 max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl lg:text-7xl font-bold text-white leading-tight">
            DeFi Lending <span className="text-yellow-400">Flash Loans</span>{" "}
            -No Collateral needed
          </h1>
          <p className="text-gray-400 text-lg leading-relaxed max-w-2xl mx-auto">
            Supply liquidity to earn yield, borrow against your assets
            instantly, and access institutional-grade financial tools.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/docs"
              className="border border-white/20 text-white hover:bg-white/10 text-lg px-8 py-4 rounded-full font-bold transition-all"
            >
              Read Documentation
            </Link>
          </div>
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <div className="bg-white/5 rounded-xl border border-white/5 overflow-hidden">
                  <div className="flex border-b border-white/5">
                    <button className="px-6 py-4 text-white font-medium border-b-2 border-yellow-400 bg-white/5">
                      Supplied
                    </button>
                    <button className="px-6 py-4 text-gray-500 font-medium hover:text-white">
                      Borrowed
                    </button>
                  </div>
                  <div className="p-4">
                      ...
                      <tbody className="text-sm">
                        <tr className="border-b border-white/5 last:border-0 group hover:bg-white/5 transition-colors">
                          <td className="py-4 pl-2 flex items-center gap-3">
                            <div className="w-8 h-8 rounded-full bg-orange-500 flex items-center justify-center text-white font-bold text-[10px]">
                              ₿
                            </div>
                  ...
                  <div className="bg-black/40 rounded-lg p-3 border border-white/5 flex justify-between items-center">
                    <div className="flex flex-col">
                      ...
                      <div className="flex items-center gap-2 text-white font-medium cursor-pointer hover:bg-white/5 px-2 py-1 rounded">
                        <div className="w-5 h-5 rounded-full bg-blue-400 flex items-center justify-center text-[8px]">
                          U
                        </div>
