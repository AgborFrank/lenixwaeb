...
import { ShieldCheck, TrendingUp, MoreHorizontal, Eye, EyeOff } from "lucide-react";
      ...
      <div className="relative z-10 flex flex-col h-full justify-between gap-8">
          ...
          <div className="flex items-center gap-3">
             ...
             <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                   {showBalance ? (
                      <span className="text-3xl sm:text-4xl font-bold text-white tracking-tight">$124,592.80</span>
                   ) : (
        ...
        <div className="flex items-end justify-between">
           ...
           <div className="flex flex-col items-end gap-1">
              <span className="text-xs text-zinc-500 uppercase tracking-widest font-bold">Security Level</span>
              <div className="flex gap-1">
                 {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="h-2 w-8 rounded-full bg-yellow-400 shadow-[0_0_10px_rgba(250,204,21,0.5)]" />
                 ))}
