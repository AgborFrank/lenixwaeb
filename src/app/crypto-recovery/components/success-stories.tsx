          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                ...
                was compromised. The Lenix Protocol team not only recovered my 45 BTC but
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700 hover:border-yellow-400/50 transition-all duration-300">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              &quot;Lost 12 ETH to a phishing scam. Lenix Protocol recovered 11.5 ETH
          ...
          <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700 hover:border-yellow-400/50 transition-all duration-300">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              ...
              impossible. The team at Lenix Protocol proved me wrong. Professional,
          ...
          <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700 hover:border-yellow-400/50 transition-all duration-300">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              ...
              Bitcoin when I thought all hope was gone. Thank you, Lenix Protocol
              team!&quot;
            </p>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-yellow-400 rounded-full flex items-center justify-center">
